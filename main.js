    ...
    return {
        init: function () {
            ...
            $(document).on("change", "#wallpaper-picker", function (event) {
                ...
                Toadkicker.$body.css({"background": "url('" + event.currentTarget.value + "') center center fixed no-repeat"})
        ...
        setBackgroundImage: function () {
            ...
            if (Toadkicker.randomImages.length > 0) {
                ...
                Toadkicker.$body.css({"background": "url('" + Toadkicker.randomImages[pickOne] + "') center center fixed no-repeat"});
            } else {
                Toadkicker.$body.css({"background": "#000000"});
            }
